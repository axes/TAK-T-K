...
export class HowToPlayScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(centerX, 120, 'CÓMO JUGAR', {
      fontFamily: 'monospace',
      fontSize: '14px',
    ...
    const lines = [
      'OBJETIVO: ELIMINA TODAS LAS UNIDADES ENEMIGAS',
      'PUNTOS DE ACCIÓN: 3 PA POR TURNO',
      'MOVER: 1 PA RECTO · 2 PA DIAGONAL',
      'ATQ. BÁSICO: 1 PA · ATQ. ESPECIAL: 2-3 PA'
    ];
